...
MANUAL_MEDAL_OVERRIDES = {
    ...
    ("22.05.2021", "ЧУ 2021 Команди"): {
        "medals": {
            "gold": "Київ-1 (Усик Сергій, Усик Артем, Ледєньов Вадим, Морозов Сергій)",
            "silver": "Кривий Ріг (Омельченко Владислав, Солтис Микита, Солтис Андрій, Кулик Віталій)",
            "bronze": ["Чернівці (Марченко Денис, Подольський Святослав, Чепурний Едуард, Мороз Артем)", "Черкаси-2"],
        },
        "medalsWomen": {
